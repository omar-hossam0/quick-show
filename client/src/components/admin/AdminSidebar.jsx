...
import { LayoutDashboardIcon, PlusSquareIcon, ListIcon, LassoSelectIcon } from "lucide-react";
...
const adminNavlinkes = [
     {name : 'Dashboard' , path : '/admin' , icon : LayoutDashboardIcon },
      {name : 'Add Shows' , path : '/admin/add-shows' , icon : PlusSquareIcon },
      {name : 'List Shows' , path : '/admin/list-shows' , icon : ListIcon },
      {name : 'List Bookings' , path : '/admin/list-bookings' , icon : LassoSelectIcon },
]
